-- Pass 94 — Owen Hall auto-ingestion roster enablement
...
values ('owen_hall','Owen Hall','pitcher','Rookie',true,'milb_stats_api','815157','473','16','success','Auto-enabled via milb_stats_api; 2026 route verified',now(),now())
