-- Pass 90 — Seaver King auto-ingestion roster enablement
...
values ('seaver_king','Seaver King','hitter','AA',true,'milb_stats_api','814409','547','12','success','Auto-enabled via milb_stats_api; 2026 game logs verified',now(),now())
