-- Pass 96 — Jacob Gonzalez auto-ingestion roster enablement
...
values ('jacob_gonzalez','Jacob Gonzalez','hitter','AAA',true,'milb_stats_api','694378','494','11','success','Auto-enabled via milb_stats_api; 2026 route verified',now(),now())
