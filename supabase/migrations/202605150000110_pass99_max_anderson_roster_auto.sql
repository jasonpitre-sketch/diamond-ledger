-- Pass 99 — Max Anderson auto-ingestion roster enablement
...
values ('max_anderson','Max Anderson','hitter','AAA',true,'milb_stats_api','801194','512','11','success','Auto-enabled via milb_stats_api; 2026 route verified',now(),now())
