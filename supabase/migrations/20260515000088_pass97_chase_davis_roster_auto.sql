-- Pass 97 — Chase Davis auto-ingestion roster enablement
...
values ('chase_davis','Chase Davis','hitter','AA',true,'milb_stats_api','690971','440','12','success','Auto-enabled via milb_stats_api; 2026 route verified',now(),now())
