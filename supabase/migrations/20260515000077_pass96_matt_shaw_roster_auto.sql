-- Pass 96 — Matt Shaw auto-ingestion roster enablement
...
values ('matt_shaw','Matt Shaw','hitter','MLB',true,'mlb_stats_api','807713','112','1','success','Auto-enabled via mlb_stats_api; 2026 route verified',now(),now())
