-- Pass 97 — Brice Matthews auto-ingestion roster enablement
...
values ('brice_matthews','Brice Matthews','hitter','MLB',true,'mlb_stats_api','694728','117','1','success','Auto-enabled via mlb_stats_api; 2026 route verified',now(),now())
