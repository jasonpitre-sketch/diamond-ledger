-- Pass 95 — Paul Skenes auto-ingestion roster enablement
...
values ('paul_skenes','Paul Skenes','pitcher','MLB',true,'mlb_stats_api','694973','134','1','success','Auto-enabled via mlb_stats_api; 2026 route verified',now(),now())
