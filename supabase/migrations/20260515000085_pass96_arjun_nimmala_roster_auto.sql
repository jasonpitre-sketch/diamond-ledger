-- Pass 96 — Arjun Nimmala auto-ingestion roster enablement
...
values ('arjun_nimmala','Arjun Nimmala','hitter','AA',true,'milb_stats_api','805796','463','12','success','Auto-enabled via milb_stats_api; 2026 route verified',now(),now())
