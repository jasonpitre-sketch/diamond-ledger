-- Pass 90 — Konnor Griffin auto-ingestion roster enablement
...
values ('konnor_griffin','Konnor Griffin','hitter','AAA',true,'milb_stats_api','804606','484','11','success','Auto-enabled via milb_stats_api; 2026 game logs verified',now(),now())
