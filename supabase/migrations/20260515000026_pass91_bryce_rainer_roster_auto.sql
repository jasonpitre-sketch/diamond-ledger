-- Pass 91 — Bryce Rainer auto-ingestion roster enablement
...
values ('bryce_rainer','Bryce Rainer','hitter','A+',true,'milb_stats_api','800614','582','13','success','Auto-enabled via milb_stats_api; 2026 game logs verified',now(),now())
