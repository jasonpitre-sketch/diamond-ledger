-- Pass 95 — Chase Dollander auto-ingestion roster enablement
...
values ('chase_dollander','Chase Dollander','pitcher','MLB',true,'mlb_stats_api','801403','115','1','success','Auto-enabled via mlb_stats_api; 2026 route verified',now(),now())
