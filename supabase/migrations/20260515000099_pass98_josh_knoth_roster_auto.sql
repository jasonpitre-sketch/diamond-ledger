-- Pass 98 — Josh Knoth auto-ingestion roster enablement
...
values ('josh_knoth','Josh Knoth','pitcher','Rookie',true,'milb_stats_api','805807','406','16','success','Auto-enabled via milb_stats_api; 2026 route verified',now(),now())
