-- Pass 94 — David Shields auto-ingestion roster enablement
...
values ('david_shields','David Shields','pitcher','A+',true,'milb_stats_api','815789','565','13','success','Auto-enabled via milb_stats_api; 2026 route verified',now(),now())
