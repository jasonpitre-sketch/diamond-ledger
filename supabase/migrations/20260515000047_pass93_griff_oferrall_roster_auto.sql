-- Pass 93 — Griff O'Ferrall auto-ingestion roster enablement
...
values ('griff_oferrall','Griff O''Ferrall','hitter','AA',true,'milb_stats_api','803172','418','12','success','Auto-enabled via milb_stats_api; 2026 game logs verified',now(),now())
