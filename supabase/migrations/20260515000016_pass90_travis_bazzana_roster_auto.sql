-- Pass 90 — Travis Bazzana auto-ingestion roster enablement
...
values ('travis_bazzana','Travis Bazzana','hitter','AAA',true,'milb_stats_api','683953','445','11','success','Auto-enabled via milb_stats_api; 2026 game logs verified',now(),now())
