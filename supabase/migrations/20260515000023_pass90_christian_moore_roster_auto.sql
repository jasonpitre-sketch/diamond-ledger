-- Pass 90 — Christian Moore auto-ingestion roster enablement
...
values ('christian_moore','Christian Moore','hitter','AAA',true,'milb_stats_api','695681','561','11','success','Auto-enabled via milb_stats_api; 2026 game logs verified',now(),now())
