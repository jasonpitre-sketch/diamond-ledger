-- Pass 93 — Brody Brecht auto-ingestion roster enablement
...
values ('brody_brecht','Brody Brecht','pitcher','A+',true,'milb_stats_api','701679','486','13','success','Auto-enabled via milb_stats_api; 2026 game logs verified',now(),now())
