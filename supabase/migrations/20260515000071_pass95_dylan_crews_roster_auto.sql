-- Pass 95 — Dylan Crews auto-ingestion roster enablement
...
values ('dylan_crews','Dylan Crews','hitter','AAA',true,'milb_stats_api','686611','534','11','success','Auto-enabled via milb_stats_api; 2026 route verified',now(),now())
