-- Pass 98 — Thomas White auto-ingestion roster enablement
...
values ('thomas_white','Thomas White','pitcher','AAA',true,'milb_stats_api','806258','564','11','success','Auto-enabled via milb_stats_api; 2026 route verified',now(),now())
