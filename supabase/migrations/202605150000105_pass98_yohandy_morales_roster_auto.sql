-- Pass 98 — Yohandy Morales auto-ingestion roster enablement
...
values ('yohandy_morales','Yohandy Morales','hitter','AAA',true,'milb_stats_api','691002','534','11','success','Auto-enabled via milb_stats_api; 2026 route verified',now(),now())
