-- Pass 97 — Jonny Farmelo auto-ingestion roster enablement
...
values ('jonny_farmelo','Jonny Farmelo','hitter','A+',true,'milb_stats_api','806071','403','13','success','Auto-enabled via milb_stats_api; 2026 route verified',now(),now())
