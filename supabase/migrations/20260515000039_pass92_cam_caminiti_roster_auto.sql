-- Pass 92 — Cam Caminiti auto-ingestion roster enablement
...
values ('cam_caminiti','Cam Caminiti','pitcher','A+',true,'milb_stats_api','807284','432','13','success','Auto-enabled via milb_stats_api; 2026 game logs verified',now(),now())
