-- Pass 95 — Noble Meyer auto-ingestion roster enablement
...
values ('noble_meyer','Noble Meyer','pitcher','A+',true,'milb_stats_api','800611','520','13','success','Auto-enabled via milb_stats_api; 2026 route verified',now(),now())
