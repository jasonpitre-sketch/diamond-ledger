-- Pass 97 — Ralphy Velazquez auto-ingestion roster enablement
...
values ('ralphy_velazquez','Ralphy Velazquez','hitter','AA',true,'milb_stats_api','806252','402','12','success','Auto-enabled via milb_stats_api; 2026 route verified',now(),now())
