-- Pass 90 — Charlie Condon auto-ingestion roster enablement
...
values ('charlie_condon','Charlie Condon','hitter','AAA',true,'milb_stats_api','809707','342','11','success','Auto-enabled via milb_stats_api; 2026 game logs verified',now(),now())
