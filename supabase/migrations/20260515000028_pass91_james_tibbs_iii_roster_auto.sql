-- Pass 91 — James Tibbs III auto-ingestion roster enablement
...
values ('james_tibbs_iii','James Tibbs III','hitter','AAA',true,'milb_stats_api','696486','238','11','success','Auto-enabled via milb_stats_api; 2026 game logs verified',now(),now())
