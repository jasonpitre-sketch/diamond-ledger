-- Pass 98 — Adrian Santana auto-ingestion roster enablement
...
values ('adrian_santana','Adrian Santana','hitter','A+',true,'milb_stats_api','803745','2498','13','success','Auto-enabled via milb_stats_api; 2026 route verified',now(),now())
