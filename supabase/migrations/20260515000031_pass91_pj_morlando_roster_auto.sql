-- Pass 91 — PJ Morlando auto-ingestion roster enablement
...
values ('pj_morlando','PJ Morlando','hitter','A',true,'milb_stats_api','703563','479','14','success','Auto-enabled via milb_stats_api; 2026 game logs verified',now(),now())
