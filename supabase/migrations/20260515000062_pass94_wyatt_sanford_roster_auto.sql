-- Pass 94 — Wyatt Sanford auto-ingestion roster enablement
...
values ('wyatt_sanford','Wyatt Sanford','hitter','A+',true,'milb_stats_api','815608','477','13','success','Auto-enabled via milb_stats_api; 2026 route verified',now(),now())
