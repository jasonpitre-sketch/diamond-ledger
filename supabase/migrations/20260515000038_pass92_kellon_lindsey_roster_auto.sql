-- Pass 92 — Kellon Lindsey auto-ingestion roster enablement
...
values ('kellon_lindsey','Kellon Lindsey','hitter','A',true,'milb_stats_api','813916','6482','14','success','Auto-enabled via milb_stats_api; 2026 game logs verified',now(),now())
