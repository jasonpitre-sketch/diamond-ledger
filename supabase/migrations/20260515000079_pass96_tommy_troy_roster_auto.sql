-- Pass 96 — Tommy Troy auto-ingestion roster enablement
...
values ('tommy_troy','Tommy Troy','hitter','AAA',true,'milb_stats_api','694371','2310','11','success','Auto-enabled via milb_stats_api; 2026 route verified',now(),now())
