-- Pass 93 — Tommy White auto-ingestion roster enablement
...
values ('tommy_white','Tommy White','hitter','AAA',true,'milb_stats_api','695720','400','11','success','Auto-enabled via milb_stats_api; 2026 game logs verified',now(),now())
