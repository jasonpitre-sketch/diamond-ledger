-- Pass 91 — Cam Smith auto-ingestion roster enablement
...
values ('cam_smith','Cam Smith','hitter','MLB',true,'mlb_stats_api','701358','117','1','success','Auto-enabled via mlb_stats_api; 2026 game logs verified',now(),now())
