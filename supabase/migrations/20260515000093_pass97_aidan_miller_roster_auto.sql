-- Pass 97 — Aidan Miller auto-ingestion roster enablement
...
values ('aidan_miller','Aidan Miller','hitter','AAA',true,'milb_stats_api','805795','1410','11','success','Auto-enabled via milb_stats_api; 2026 route verified',now(),now())
