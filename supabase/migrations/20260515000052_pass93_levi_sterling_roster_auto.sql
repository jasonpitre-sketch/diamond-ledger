-- Pass 93 — Levi Sterling auto-ingestion roster enablement
...
values ('levi_sterling','Levi Sterling','pitcher','A',true,'milb_stats_api','815552','3390','14','success','Auto-enabled via milb_stats_api; 2026 game logs verified',now(),now())
