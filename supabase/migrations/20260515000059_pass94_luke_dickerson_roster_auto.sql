-- Pass 94 — Luke Dickerson auto-ingestion roster enablement
...
values ('luke_dickerson','Luke Dickerson','hitter','A',true,'milb_stats_api','815380','436','14','success','Auto-enabled via milb_stats_api; 2026 route verified',now(),now())
