-- Pass 88 — Jake McCarthy auto-ingestion roster enablement
...
values ('jake_mccarthy','Jake McCarthy','hitter','MLB',true,'mlb_stats_api','664983','115','1','success','Auto-enabled via MLB Stats API; 2026 MLB game logs verified',now(),now())
