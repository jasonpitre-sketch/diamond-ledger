-- Pass 95 — Wyatt Langford auto-ingestion roster enablement
...
values ('wyatt_langford','Wyatt Langford','hitter','MLB',true,'mlb_stats_api','694671','140','1','success','Auto-enabled via mlb_stats_api; 2026 route verified',now(),now())
