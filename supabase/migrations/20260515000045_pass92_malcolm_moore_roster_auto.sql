-- Pass 92 — Malcolm Moore auto-ingestion roster enablement
...
values ('malcolm_moore','Malcolm Moore','hitter','A+',true,'milb_stats_api','702270','6324','13','success','Auto-enabled via milb_stats_api; 2026 game logs verified',now(),now())
