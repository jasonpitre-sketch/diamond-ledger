-- Pass 91 — Braylon Payne auto-ingestion roster enablement
...
values ('braylon_payne','Braylon Payne','hitter','A+',true,'milb_stats_api','815520','572','13','success','Auto-enabled via milb_stats_api; 2026 game logs verified',now(),now())
