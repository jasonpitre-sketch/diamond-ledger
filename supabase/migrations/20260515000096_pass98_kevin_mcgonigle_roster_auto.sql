-- Pass 98 — Kevin McGonigle auto-ingestion roster enablement
...
values ('kevin_mcgonigle','Kevin McGonigle','hitter','MLB',true,'mlb_stats_api','805808','116','1','success','Auto-enabled via mlb_stats_api; 2026 route verified',now(),now())
