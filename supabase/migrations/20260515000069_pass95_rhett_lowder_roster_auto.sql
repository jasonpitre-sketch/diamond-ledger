-- Pass 95 — Rhett Lowder auto-ingestion roster enablement
...
values ('rhett_lowder','Rhett Lowder','pitcher','MLB',true,'mlb_stats_api','695076','113','1','success','Auto-enabled via mlb_stats_api; 2026 route verified',now(),now())
