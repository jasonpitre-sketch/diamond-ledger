-- Pass 96 — Bryce Eldridge auto-ingestion roster enablement
...
values ('bryce_eldridge','Bryce Eldridge','hitter','MLB',true,'mlb_stats_api','805811','137','1','success','Auto-enabled via mlb_stats_api; 2026 route verified',now(),now())
