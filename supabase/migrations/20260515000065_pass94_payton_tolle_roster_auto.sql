-- Pass 94 — Payton Tolle auto-ingestion roster enablement
...
values ('payton_tolle','Payton Tolle','pitcher','MLB',true,'mlb_stats_api','801139','111','1','success','Auto-enabled via mlb_stats_api; 2026 route verified',now(),now())
