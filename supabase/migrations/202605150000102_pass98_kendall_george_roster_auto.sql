-- Pass 98 — Kendall George auto-ingestion roster enablement
...
values ('kendall_george','Kendall George','hitter','AA',true,'milb_stats_api','806077','260','12','success','Auto-enabled via milb_stats_api; 2026 route verified',now(),now())
