-- Pass 98 — Colin Houck auto-ingestion roster enablement
...
values ('colin_houck','Colin Houck','hitter','A+',true,'milb_stats_api','806124','453','13','success','Auto-enabled via milb_stats_api; 2026 route verified',now(),now())
