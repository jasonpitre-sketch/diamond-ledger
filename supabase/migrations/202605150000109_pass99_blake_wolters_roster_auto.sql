-- Pass 99 — Blake Wolters auto-ingestion roster enablement
...
values ('blake_wolters','Blake Wolters','pitcher','A+',true,'milb_stats_api','806265','565','13','success','Auto-enabled via milb_stats_api; 2026 route verified',now(),now())
