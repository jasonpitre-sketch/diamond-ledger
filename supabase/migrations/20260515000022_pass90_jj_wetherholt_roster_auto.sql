-- Pass 90 — JJ Wetherholt auto-ingestion roster enablement
...
values ('jj_wetherholt','JJ Wetherholt','hitter','MLB',true,'mlb_stats_api','802139','138','1','success','Auto-enabled via mlb_stats_api; 2026 game logs verified',now(),now())
