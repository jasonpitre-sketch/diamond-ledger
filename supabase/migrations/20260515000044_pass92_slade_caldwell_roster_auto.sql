-- Pass 92 — Slade Caldwell auto-ingestion roster enablement
...
values ('slade_caldwell','Slade Caldwell','hitter','A+',true,'milb_stats_api','815154','419','13','success','Auto-enabled via milb_stats_api; 2026 game logs verified',now(),now())
