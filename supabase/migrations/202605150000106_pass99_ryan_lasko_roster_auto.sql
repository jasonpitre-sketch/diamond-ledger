-- Pass 99 — Ryan Lasko auto-ingestion roster enablement
...
values ('ryan_lasko','Ryan Lasko','hitter','AA',true,'milb_stats_api','805782','237','12','success','Auto-enabled via milb_stats_api; 2026 route verified',now(),now())
