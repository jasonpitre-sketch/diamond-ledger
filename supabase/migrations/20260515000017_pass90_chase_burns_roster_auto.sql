-- Pass 90 — Chase Burns auto-ingestion roster enablement
...
values ('chase_burns','Chase Burns','pitcher','MLB',true,'mlb_stats_api','695505','113','1','success','Auto-enabled via mlb_stats_api; 2026 game logs verified',now(),now())
