-- Pass 97 — Hurston Waldrep auto-ingestion roster enablement
...
values ('hurston_waldrep','Hurston Waldrep','pitcher','MLB',true,'mlb_stats_api','694462','144','1','success','Auto-enabled via mlb_stats_api; 2026 route verified',now(),now())
