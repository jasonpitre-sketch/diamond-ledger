-- Pass 99 — Luke Keaschall auto-ingestion roster enablement
...
values ('luke_keaschall','Luke Keaschall','hitter','MLB',true,'mlb_stats_api','807712','142','1','success','Auto-enabled via mlb_stats_api; 2026 route verified',now(),now())
