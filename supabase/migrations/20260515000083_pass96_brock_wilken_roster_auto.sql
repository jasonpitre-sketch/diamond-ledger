-- Pass 96 — Brock Wilken auto-ingestion roster enablement
...
values ('brock_wilken','Brock Wilken','hitter','AAA',true,'milb_stats_api','694385','556','11','success','Auto-enabled via milb_stats_api; 2026 route verified',now(),now())
