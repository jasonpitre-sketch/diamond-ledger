-- Pass 93 — Braylon Doughty auto-ingestion roster enablement
...
values ('braylon_doughty','Braylon Doughty','pitcher','A+',true,'milb_stats_api','815785','437','13','success','Auto-enabled via milb_stats_api; 2026 game logs verified',now(),now())
