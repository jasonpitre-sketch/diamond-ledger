-- Pass 94 — Chris Cortez auto-ingestion roster enablement
...
values ('chris_cortez','Chris Cortez','pitcher','AA',true,'milb_stats_api','700933','559','12','success','Auto-enabled via milb_stats_api; 2026 route verified',now(),now())
