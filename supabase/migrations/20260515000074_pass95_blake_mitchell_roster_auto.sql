-- Pass 95 — Blake Mitchell auto-ingestion roster enablement
...
values ('blake_mitchell','Blake Mitchell','hitter','A+',true,'milb_stats_api','805810','565','13','success','Auto-enabled via milb_stats_api; 2026 route verified',now(),now())
