-- Pass 95 — Max Clark auto-ingestion roster enablement
...
values ('max_clark','Max Clark','hitter','AAA',true,'milb_stats_api','703601','512','11','success','Auto-enabled via milb_stats_api; 2026 route verified',now(),now())
