-- Pass 95 — Jacob Wilson auto-ingestion roster enablement
...
values ('jacob_wilson','Jacob Wilson','hitter','MLB',true,'mlb_stats_api','805779','133','1','success','Auto-enabled via mlb_stats_api; 2026 route verified',now(),now())
