-- Pass 98 — Charlee Soto auto-ingestion roster enablement
...
values ('charlee_soto','Charlee Soto','pitcher','AAA',true,'milb_stats_api','805792','492','11','success','Auto-enabled via milb_stats_api; 2026 route verified',now(),now())
