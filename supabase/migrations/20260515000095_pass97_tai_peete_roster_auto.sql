-- Pass 97 — Tai Peete auto-ingestion roster enablement
...
values ('tai_peete','Tai Peete','hitter','A+',true,'milb_stats_api','806191','443','13','success','Auto-enabled via milb_stats_api; 2026 route verified',now(),now())
