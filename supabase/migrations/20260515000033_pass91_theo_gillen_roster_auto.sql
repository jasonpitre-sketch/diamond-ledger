-- Pass 91 — Theo Gillen auto-ingestion roster enablement
...
values ('theo_gillen','Theo Gillen','hitter','A+',true,'milb_stats_api','815394','2498','13','success','Auto-enabled via milb_stats_api; 2026 game logs verified',now(),now())
