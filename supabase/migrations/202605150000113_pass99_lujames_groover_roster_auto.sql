-- Pass 99 — LuJames Groover auto-ingestion roster enablement
...
values ('lujames_groover','LuJames Groover','hitter','AAA',true,'milb_stats_api','694410','2310','11','success','Auto-enabled via milb_stats_api; 2026 route verified',now(),now())
