-- Pass 99 — Kemp Alderman auto-ingestion roster enablement
...
values ('kemp_alderman','Kemp Alderman','hitter','AAA',true,'milb_stats_api','694580','564','11','success','Auto-enabled via milb_stats_api; 2026 route verified',now(),now())
