-- Pass 96 — Kyle Teel auto-ingestion roster enablement
...
values ('kyle_teel','Kyle Teel','hitter','AAA',true,'milb_stats_api','691019','494','11','success','Auto-enabled via milb_stats_api; 2026 route verified',now(),now())
