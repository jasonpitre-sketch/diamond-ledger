-- Pass 99 — Mitch Jebb auto-ingestion roster enablement
...
values ('mitch_jebb','Mitch Jebb','hitter','AAA',true,'milb_stats_api','694991','484','11','success','Auto-enabled via milb_stats_api; 2026 route verified',now(),now())
