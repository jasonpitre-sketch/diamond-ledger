-- Pass 96 — Brayden Taylor auto-ingestion roster enablement
...
values ('brayden_taylor','Brayden Taylor','hitter','AA',true,'milb_stats_api','694966','421','12','success','Auto-enabled via milb_stats_api; 2026 route verified',now(),now())
