-- Pass 94 — Jared Thomas auto-ingestion roster enablement
...
values ('jared_thomas','Jared Thomas','hitter','AA',true,'milb_stats_api','703606','538','12','success','Auto-enabled via milb_stats_api; 2026 route verified',now(),now())
