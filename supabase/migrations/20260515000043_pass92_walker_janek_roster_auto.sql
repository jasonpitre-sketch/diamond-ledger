-- Pass 92 — Walker Janek auto-ingestion roster enablement
...
values ('walker_janek','Walker Janek','hitter','AA',true,'milb_stats_api','801075','482','12','success','Auto-enabled via milb_stats_api; 2026 game logs verified',now(),now())
