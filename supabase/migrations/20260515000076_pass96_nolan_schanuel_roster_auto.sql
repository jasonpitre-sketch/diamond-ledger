-- Pass 96 — Nolan Schanuel auto-ingestion roster enablement
...
values ('nolan_schanuel','Nolan Schanuel','hitter','MLB',true,'mlb_stats_api','694384','108','1','success','Auto-enabled via mlb_stats_api; 2026 route verified',now(),now())
