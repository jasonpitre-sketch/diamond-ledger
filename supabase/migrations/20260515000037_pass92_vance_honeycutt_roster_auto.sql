-- Pass 92 — Vance Honeycutt auto-ingestion roster enablement
...
values ('vance_honeycutt','Vance Honeycutt','hitter','A+',true,'milb_stats_api','701689','493','13','success','Auto-enabled via milb_stats_api; 2026 game logs verified',now(),now())
