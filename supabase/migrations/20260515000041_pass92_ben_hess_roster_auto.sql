-- Pass 92 — Ben Hess auto-ingestion roster enablement
...
values ('ben_hess','Ben Hess','pitcher','AA',true,'milb_stats_api','696292','1956','12','success','Auto-enabled via milb_stats_api; 2026 game logs verified',now(),now())
