-- Pass 98 — Ty Floyd auto-ingestion roster enablement
...
values ('ty_floyd','Ty Floyd','pitcher','Rookie',true,'milb_stats_api','692226','450','16','success','Auto-enabled via milb_stats_api; 2026 route verified',now(),now())
