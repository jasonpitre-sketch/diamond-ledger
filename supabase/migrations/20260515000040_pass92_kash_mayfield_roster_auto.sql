-- Pass 92 — Kash Mayfield auto-ingestion roster enablement
...
values ('kash_mayfield','Kash Mayfield','pitcher','A+',true,'milb_stats_api','824026','584','13','success','Auto-enabled via milb_stats_api; 2026 game logs verified',now(),now())
