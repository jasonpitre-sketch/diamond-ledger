-- Pass 90 — Nick Kurtz auto-ingestion roster enablement
...
values ('nick_kurtz','Nick Kurtz','hitter','MLB',true,'mlb_stats_api','701762','133','1','success','Auto-enabled via mlb_stats_api; 2026 game logs verified',now(),now())
