-- Pass 94 — Jacob Cozart auto-ingestion roster enablement
...
values ('jacob_cozart','Jacob Cozart','hitter','AA',true,'milb_stats_api','695524','402','12','success','Auto-enabled via milb_stats_api; 2026 route verified',now(),now())
