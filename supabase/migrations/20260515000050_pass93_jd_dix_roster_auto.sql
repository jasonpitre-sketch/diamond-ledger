-- Pass 93 — JD Dix auto-ingestion roster enablement
...
values ('jd_dix','JD Dix','hitter','A',true,'milb_stats_api','807267','516','14','success','Auto-enabled via milb_stats_api; 2026 game logs verified',now(),now())
