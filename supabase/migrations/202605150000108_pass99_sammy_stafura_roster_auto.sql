-- Pass 99 — Sammy Stafura auto-ingestion roster enablement
...
values ('sammy_stafura','Sammy Stafura','hitter','A+',true,'milb_stats_api','806230','477','13','success','Auto-enabled via milb_stats_api; 2026 route verified',now(),now())
