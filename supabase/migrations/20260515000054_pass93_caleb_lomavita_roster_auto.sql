-- Pass 93 — Caleb Lomavita auto-ingestion roster enablement
...
values ('caleb_lomavita','Caleb Lomavita','hitter','AA',true,'milb_stats_api','701616','547','12','success','Auto-enabled via milb_stats_api; 2026 game logs verified',now(),now())
