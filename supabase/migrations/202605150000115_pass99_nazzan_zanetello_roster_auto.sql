-- Pass 99 — Nazzan Zanetello auto-ingestion roster enablement
...
values ('nazzan_zanetello','Nazzan Zanetello','hitter','A+',true,'milb_stats_api','805801','428','13','success','Auto-enabled via milb_stats_api; 2026 route verified',now(),now())
