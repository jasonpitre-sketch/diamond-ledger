-- Pass 93 — Kyle DeBarge auto-ingestion roster enablement
...
values ('kyle_debarge','Kyle DeBarge','hitter','AA',true,'milb_stats_api','814414','3898','12','success','Auto-enabled via milb_stats_api; 2026 game logs verified',now(),now())
