-- Pass 92 — Dante Nori auto-ingestion roster enablement
...
values ('dante_nori','Dante Nori','hitter','AA',true,'milb_stats_api','807276','522','12','success','Auto-enabled via milb_stats_api; 2026 game logs verified',now(),now())
