-- Pass 95 — Walker Jenkins auto-ingestion roster enablement
...
values ('walker_jenkins','Walker Jenkins','hitter','AAA',true,'milb_stats_api','805805','1960','11','success','Auto-enabled via milb_stats_api; 2026 route verified',now(),now())
