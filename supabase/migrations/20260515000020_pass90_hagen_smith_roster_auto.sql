-- Pass 90 — Hagen Smith auto-ingestion roster enablement
...
values ('hagen_smith','Hagen Smith','pitcher','AAA',true,'milb_stats_api','696146','494','11','success','Auto-enabled via milb_stats_api; 2026 game logs verified',now(),now())
