-- Pass 97 — Dillon Head auto-ingestion roster enablement
...
values ('dillon_head','Dillon Head','hitter','A+',true,'milb_stats_api','702977','554','13','success','Auto-enabled via milb_stats_api; 2026 route verified',now(),now())
