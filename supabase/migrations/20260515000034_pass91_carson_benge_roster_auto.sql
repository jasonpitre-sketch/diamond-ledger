-- Pass 91 — Carson Benge auto-ingestion roster enablement
...
values ('carson_benge','Carson Benge','hitter','MLB',true,'mlb_stats_api','701807','121','1','success','Auto-enabled via mlb_stats_api; 2026 game logs verified',now(),now())
