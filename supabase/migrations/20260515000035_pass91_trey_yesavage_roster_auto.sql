-- Pass 91 — Trey Yesavage auto-ingestion roster enablement
...
values ('trey_yesavage','Trey Yesavage','pitcher','MLB',true,'mlb_stats_api','702056','141','1','success','Auto-enabled via mlb_stats_api; 2026 game logs verified',now(),now())
