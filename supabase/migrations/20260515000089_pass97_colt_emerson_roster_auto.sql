-- Pass 97 — Colt Emerson auto-ingestion roster enablement
...
values ('colt_emerson','Colt Emerson','hitter','AAA',true,'milb_stats_api','806068','529','11','success','Auto-enabled via milb_stats_api; 2026 route verified',now(),now())
