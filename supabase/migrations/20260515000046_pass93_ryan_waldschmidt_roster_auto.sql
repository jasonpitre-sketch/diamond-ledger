-- Pass 93 — Ryan Waldschmidt auto-ingestion roster enablement
...
values ('ryan_waldschmidt','Ryan Waldschmidt','hitter','MLB',true,'mlb_stats_api','814439','109','1','success','Auto-enabled via mlb_stats_api; 2026 game logs verified',now(),now())
