-- Pass 93 — Blake Burke auto-ingestion roster enablement
...
values ('blake_burke','Blake Burke','hitter','AA',true,'milb_stats_api','695501','5015','12','success','Auto-enabled via milb_stats_api; 2026 game logs verified',now(),now())
