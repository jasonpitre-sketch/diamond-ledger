-- Pass 99 — Sean Sullivan auto-ingestion roster enablement
...
values ('sean_sullivan','Sean Sullivan','pitcher','AAA',true,'milb_stats_api','807743','342','11','success','Auto-enabled via milb_stats_api; 2026 route verified',now(),now())
