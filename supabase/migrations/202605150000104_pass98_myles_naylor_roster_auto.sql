-- Pass 98 — Myles Naylor auto-ingestion roster enablement
...
values ('myles_naylor','Myles Naylor','hitter','A+',true,'milb_stats_api','802504','499','13','success','Auto-enabled via milb_stats_api; 2026 route verified',now(),now())
