...
const data = JSON.parse(fs.readFileSync(new URL("../games/sean_sullivan-2026.json", import.meta.url), "utf8"))
const dryRun = process.argv.includes("--dry-run")
console.log("Sean Sullivan replay writer " + (dryRun ? "dry-run" : "dry-run only"))
