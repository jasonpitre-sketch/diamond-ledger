...
const data = JSON.parse(fs.readFileSync(new URL("../games/luke_keaschall-2026.json", import.meta.url), "utf8"))
const dryRun = process.argv.includes("--dry-run")
console.log("Luke Keaschall replay writer " + (dryRun ? "dry-run" : "dry-run only"))
