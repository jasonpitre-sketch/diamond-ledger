...
const data = JSON.parse(fs.readFileSync(new URL("../games/nazzan_zanetello-2026.json", import.meta.url), "utf8"))
const dryRun = process.argv.includes("--dry-run")
console.log("Nazzan Zanetello replay writer " + (dryRun ? "dry-run" : "dry-run only"))
