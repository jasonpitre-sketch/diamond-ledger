/**
 * BOHM 2026 REPLAY ENGINE — Pass 78 (2026-05-15)
 * Fetches Alec Bohm's 2026 MLB game log, computes days-based rolling windows,
 * weekly DLR snapshots, an April settlement, and optionally refreshes
 * games/alec_bohm-2026.json.
 *
 * Source: MLB Stats API — player 664761, sport_id 1, season 2026.
 * Engine version: P60.
 *
 * Usage:
...
const PLAYER_ID = "alec_bohm"
const MLBAM_ID = 664761
const SEASON = 2026
const ENGINE_VERSION = "P60"
const BASELINE_AVG = 0.287
const BASE_DLR = 41.7
...
console.log("=== BOHM 2026 REPLAY — PASS 78 COMPUTATION OUTPUT ===\n")
...
if (WRITE_JSON) {
  ...
  writeFileSync(join(ROOT, "games", "alec_bohm-2026.json"), JSON.stringify(out, null, 2) + "\n")
  console.log("\nWrote games/alec_bohm-2026.json")
}
