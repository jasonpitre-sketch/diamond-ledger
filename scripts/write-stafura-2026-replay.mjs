...
const data = JSON.parse(fs.readFileSync(new URL("../games/sammy_stafura-2026.json", import.meta.url), "utf8"))
const dryRun = process.argv.includes("--dry-run")
console.log("Sammy Stafura replay writer " + (dryRun ? "dry-run" : "dry-run only"))
