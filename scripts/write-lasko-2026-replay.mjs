...
const data = JSON.parse(fs.readFileSync(new URL("../games/ryan_lasko-2026.json", import.meta.url), "utf8"))
const dryRun = process.argv.includes("--dry-run")
console.log("Ryan Lasko replay writer " + (dryRun ? "dry-run" : "dry-run only"))
