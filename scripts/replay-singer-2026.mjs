/**
 * SINGER 2026 REPLAY ENGINE — Pass 80 (2026-05-15)
 * Fetches Brady Singer's 2026 MLB start log, computes starts-based rolling
 * windows, weekly DLR snapshots, an April settlement, and optionally refreshes
 * games/brady_singer-2026.json.
 *
 * Source: MLB Stats API — player 663903, sport_id 1, season 2026.
 * Engine version: P60.
 *
 * Usage:
...
const PLAYER_ID = "brady_singer"
const MLBAM_ID = 663903
const SEASON = 2026
const ENGINE_VERSION = "P60"
const BASELINE_ERA = 4.03
const BASE_DLR = 42.0
...
console.log("=== SINGER 2026 REPLAY — PASS 80 COMPUTATION OUTPUT ===\n")
...
if (WRITE_JSON) {
  ...
  writeFileSync(join(ROOT, "games", "brady_singer-2026.json"), JSON.stringify(out, null, 2) + "\n")
  console.log("\nWrote games/brady_singer-2026.json")
}
