/**
 * TURANG 2026 REPLAY ENGINE — Pass 79 (2026-05-15)
 * Fetches Brice Turang's 2026 MLB game log, computes days-based rolling windows,
 * weekly DLR snapshots, an April settlement, and optionally refreshes
 * games/brice_turang-2026.json.
 *
 * Source: MLB Stats API — player 668930, sport_id 1, season 2026.
 * Engine version: P60.
 *
 * Usage:
...
const PLAYER_ID = "brice_turang"
const MLBAM_ID = 668930
const SEASON = 2026
const ENGINE_VERSION = "P60"
const BASELINE_AVG = 0.288
const BASE_DLR = 60.0
...
console.log("=== TURANG 2026 REPLAY — PASS 79 COMPUTATION OUTPUT ===\n")
...
if (WRITE_JSON) {
  ...
  writeFileSync(join(ROOT, "games", "brice_turang-2026.json"), JSON.stringify(out, null, 2) + "\n")
  console.log("\nWrote games/brice_turang-2026.json")
}
