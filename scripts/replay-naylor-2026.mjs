/**
 * NAYLOR 2026 REPLAY ENGINE — Pass 87 (2026-05-15)
 * Fetches Alec Naylor's 2026 MLB game log, computes days-based rolling windows,
 * weekly DLR snapshots, an April settlement, and optionally refreshes
 * games/bo_naylor-2026.json.
 *
 * Source: MLB Stats API — player 666310, sport_id 1, season 2026.
 * Engine version: P60.
 *
 * Usage:
...
const MLBAM_ID = 666310
const SEASON = 2026
const ENGINE_VERSION = "P60"
const BASELINE_AVG = 0.195
const BASE_DLR = 41.7
...
console.log("=== NAYLOR 2026 REPLAY — PASS 78 COMPUTATION OUTPUT ===\n")
...
if (WRITE_JSON) {
  ...
  writeFileSync(join(ROOT, "games", "bo_naylor-2026.json"), JSON.stringify(out, null, 2) + "\n")
  console.log("\nWrote games/bo_naylor-2026.json")
}
